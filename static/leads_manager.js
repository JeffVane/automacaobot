...
function createLeadCard(lead, type) {
    ...
    card.setAttribute('data-phone', lead.telefone ? lead.telefone.toLowerCase() : '');
    card.setAttribute('data-site', lead.site ? lead.site.toLowerCase() : '');
    card.setAttribute('data-category', lead.categoria ? lead.categoria.toLowerCase() : '');
...
function startPolling() {
    const pollingInterval = 5000; // Intervalo de polling em milissegundos (5 segundos)
